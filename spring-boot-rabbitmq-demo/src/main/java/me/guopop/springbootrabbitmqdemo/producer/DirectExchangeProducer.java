...
public class DirectExchangeProducer {
    ...
    public void syncSend(String msg) {
        rabbitTemplate.convertAndSend(DirectExchangeMessage.EXCHANGE, DirectExchangeMessage.ROUTING_KEY, msg);
    }

    public void syncSendDefault(String msg) {
        rabbitTemplate.convertAndSend(DirectExchangeMessage.QUEUE, msg);
    }
