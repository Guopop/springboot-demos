...
public class AcknowledgeProducer {
    ...
    public void syncSend(String msg) {
        rabbitTemplate.convertAndSend(AcknowledgeMessage.EXCHANGE, AcknowledgeMessage.ROUTING_KEY, msg);
    }

    public void syncSendDefault(String msg) {
        rabbitTemplate.convertAndSend(AcknowledgeMessage.QUEUE, msg);
    }
